    ...
    list: [
      { name: "auth", done: false },
      {
        ...
        sub: [
          ...
          { name: "auto disconnect", done: true },
          { name: "custom disconnect timeout (via web)", done: true },
        ],
      },
      {
      ...
      },
      {
        ...
        sub: [
          ...
          { name: "add custom audio (via web)", done: true },
      ...
      },
      {
        ...
        sub: [
          ...
          { name: "play (by Playlist)", done: true },
          { name: "display current music (via web)", done: true },
          { name: "display queue (via web)", done: false },
          { name: "add TTS to queue", done: false },
          { name: "add music to queue", done: false },
          { name: "add music to queue (via web)", done: true },
          { name: "add playlist to queue", done: false },
          { name: "add playlist to queue (via web)", done: true },
          { name: "add audio to queue (via web)", done: true },
          { name: "resume", done: false },
          { name: "resume (via web)", done: true },
          { name: "pause", done: false },
          { name: "pause (via web)", done: true },
          { name: "skip", done: false },
          { name: "skip (via web)", done: true },
          { name: "stop", done: false },
          { name: "stop (via web)", done: true },
        ],
      },
      {
        name: "playlist",
        ...
        sub: [
          ...
          { name: "permission to call by role", done: false },
          {
            ...
            sub: [
              ...
              { name: "by role (via web)", done: true },
              { name: "by user", done: false },
              { name: "by user (via web)", done: true },
            ],
          },
        ],
      },
